	...
	<div class="col-md-12">
		...
		<div class="panel panel-default">
			<div class="panel-heading">
				<div class="page-heading"> <i class="glyphicon glyphicon-edit"></i> Cadastrar Dev</div>
			</div> <!-- /panel-heading -->
			<div class="panel-body">
				...
				<div class="div-action pull pull-right" style="padding-bottom:20px;">
					<button class="btn btn-default button1" data-toggle="modal" id="addProductModalBtn" data-target="#addProductModal"> <i class="glyphicon glyphicon-plus-sign"></i> Adicionar Dev </button>
				</div> <!-- /div-action -->				
				
				<table class="table" id="manageProductTable">
					<thead>
						<tr>
							<th style="width:10%;">Desenvolvedor</th>							
							<th>Servico</th>
							<th>Tempo</th>							
							<th>Modificacao</th>
							<th>Job</th>
    ...
    <div class="modal-content">
    	...
    	<form class="form-horizontal" id="submitProductForm" action="php_action/createProduct.php" method="POST" enctype="multipart/form-data">
	      <div class="modal-header">
	        ...
	        <h4 class="modal-title"><i class="fa fa-plus"></i> Adicionar Dev</h4>
	      </div>
	      ...
	      <div class="modal-body" style="max-height:450px; overflow:auto;">
	      	...
	      	<div class="form-group">
	        	<label for="productImage" class="col-sm-3 control-label">Perfil Dev: </label>
	        ...
	        <div class="form-group">
	        	<label for="productName" class="col-sm-3 control-label">Nome: </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
				      <input type="text" class="form-control" id="productName" pl name="productName" autocomplete="off">
				    </div>
	        </div> <!-- /form-group-->	    

	        <div class="form-group">
	        	<label for="quantity" class="col-sm-3 control-label">Modificacoes: </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
	        ...
	        <div class="form-group">
	        	<label for="rate" class="col-sm-3 control-label">Tempo: </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
	        ...
	        <div class="form-group">
	        	<label for="categoryName" class="col-sm-3 control-label">Developer: </label>
	        	<label class="col-sm-1 control-label">: </label>
				    <div class="col-sm-8">
