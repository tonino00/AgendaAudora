...
<h4>
	...
	<?php if($_GET['o'] == 'add') {
		echo "Adicionar Agendamento";
	} else if($_GET['o'] == 'manord') { 
		echo "Gerenciar Agendamento";
	} else if($_GET['o'] == 'editOrd') { 
		echo "Editar Gerenciamento";
	}
	?>	
</h4>
...
<div class="panel panel-default">
	<div class="panel-heading">
		...
		<?php if($_GET['o'] == 'add') { ?>
  		<i class="glyphicon glyphicon-plus-sign"></i>	 Agendamento
		<?php } else if($_GET['o'] == 'manord') { ?>
			<i class="glyphicon glyphicon-edit"></i> Gerar Agendamento
		<?php } else if($_GET['o'] == 'editOrd') { ?>
			<i class="glyphicon glyphicon-edit"></i> Editar Agendamento
		<?php } ?>
		...
		<?php if($_GET['o'] == 'add') { 
  		...
  		<form class="form-horizontal" method="POST" action="php_action/createOrder.php" id="createOrderForm">
			  ...
			  <div class="form-group">
			    <label for="orderDate" class="col-sm-2 control-label">Data do Agendamento</label>
			    <div class="col-sm-10">
			  ...
			  <div class="form-group">
			    <label for="clientContact" class="col-sm-2 control-label">Contato</label>
			    <div class="col-sm-10">
			  ...
			  <div class="col-md-6">
			  	<div class="form-group">
				    <label for="subTotal" class="col-sm-3 control-label">Valor atual</label>
				    <div class="col-sm-9">
				  ...
				  <div class="form-group">
				    <label for="totalAmount" class="col-sm-3 control-label">Valor total</label>
				    <div class="col-sm-9">
				  ...
				  <div class="form-group">
				    <label for="discount" class="col-sm-3 control-label">Desconto</label>
				    <div class="col-sm-9">
				      <input type="text" class="form-control" id="discount" name="discount" onkeyup="discountFunc()" autocomplete="off" />
				    </div>
				  </div> <!--/form-group-->	
				  <div class="form-group">
				    <label for="grandTotal" class="col-sm-3 control-label">Valor total</label>
				    <div class="col-sm-9">
			  ...
			  <div class="col-md-6">
			  	<div class="form-group">
				    <label for="paid" class="col-sm-3 control-label">Valor Pago</label>
				    <div class="col-sm-9">
				      <input type="text" class="form-control" id="paid" name="paid" autocomplete="off" onkeyup="paidAmount()" />
				    </div>
				  </div> <!--/form-group-->			  
				  <div class="form-group">
				    <label for="due" class="col-sm-3 control-label"> Em debito</label>
				    <div class="col-sm-9">
				  ...
				  <div class="form-group">
				    <label for="clientContact" class="col-sm-3 control-label">Status de Pagamento</label>
				    <div class="col-sm-9">
				      <select class="form-control" name="paymentStatus" id="paymentStatus">
				      	<option value="">~~SELECIONAR~~</option>
				      	<option value="1">Pagamento efetuado</option>
				      	<option value="2">Andamento do pagamento</option>
			  ...
			  <div class="form-group submitButtonFooter">
			    ...
			    <button type="button" class="btn btn-default" onclick="addRow()" id="addRowBtn" data-loading-text="Loading..."> <i class="glyphicon glyphicon-plus-sign"></i> Adicionar novo </button>

			      <button type="submit" id="createOrderBtn" data-loading-text="Loading..." class="btn btn-success"><i class="glyphicon glyphicon-ok-sign"></i> Salvar</button>

			      <button type="reset" class="btn btn-default" onclick="resetOrderForm()"><i class="glyphicon glyphicon-erase"></i> Desfazer</button>
			    </div>
			  </div>
			</form>
		<?php } else if($_GET['o'] == 'manord') { 
		...
		// /else manage order
  		...
  		<form class="form-horizontal" method="POST" action="php_action/editOrder.php" id="editOrderForm">
			  ...
			  <div class="form-group editButtonFooter">
			    ...
			    <button type="submit" id="editOrderBtn" data-loading-text="Loading..." class="btn btn-success"><i class="glyphicon glyphicon-ok-sign"></i> Salvar</button>
